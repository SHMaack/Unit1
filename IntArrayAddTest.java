...
public class IntArrayAddTest {
    ...
    public void testAddOneValue() 
    {
        ...
        {
            throw new RuntimeException("The add method was implemented incorrectly."
            		+ " Should have 1 element with the value of 1.");
        }
    ...
    public void testAddMultiple() 
    {
        ...
        if (!intArrayEquals.equals(iadd.getData())) {
            throw new RuntimeException("The add method was implemented incorrectly."
            		+ " Should have 3 element with the value of 1, 2, and 3.");
        }
